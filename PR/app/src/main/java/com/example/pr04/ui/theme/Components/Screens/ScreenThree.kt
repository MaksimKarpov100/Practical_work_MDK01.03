    ...
    Surface(
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            ...
            Column(
                ...
                CenterText(text = "Уведомления", modifier = Modifier.fillMaxWidth().padding(bottom = 23.dp))
                SmallText(text = "Вы быстро узнаете о результатах", modifier = Modifier.fillMaxWidth())
            }
            ...
            Column(
                ...
                OnboardingDotIndicator(currentScreen = 3, modifier = Modifier.fillMaxWidth())
            }
            ...
            Column(
                ...
                IllustrationOnboardImage(modifier = Modifier.fillMaxWidth().size(320.dp))
            }
