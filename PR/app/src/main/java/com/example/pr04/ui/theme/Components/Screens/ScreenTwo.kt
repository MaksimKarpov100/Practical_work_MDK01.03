    ...
    Surface(
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            ...
            Column(
                ...
                CenterText(text = "Мониторинг", modifier = Modifier.fillMaxWidth().padding(bottom = 23.dp))
                SmallText(
            ...
            Column(
                ...
                OnboardingDotIndicator(currentScreen = 2, modifier = Modifier.fillMaxWidth())
            }
            ...
            Column(
                ...
                IllustrationOnboardImage(modifier = Modifier.fillMaxWidth().size(300.dp))
            }
